...
HD_PWD='Y:/C++/Uni-CPU/CPURev1/PYNQ_CONFIG.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Everything_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Everything_wrapper.tcl -notrace
