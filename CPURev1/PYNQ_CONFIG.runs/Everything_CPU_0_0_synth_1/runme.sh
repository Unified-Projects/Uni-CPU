...
HD_PWD='Y:/C++/Uni-CPU/CPURev1/PYNQ_CONFIG.runs/Everything_CPU_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Everything_CPU_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Everything_CPU_0_0.tcl
