...
HD_PWD='Y:/C++/Uni-CPU/CPURev1/PYNQ_CONFIG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Everything_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Everything_wrapper.tcl
