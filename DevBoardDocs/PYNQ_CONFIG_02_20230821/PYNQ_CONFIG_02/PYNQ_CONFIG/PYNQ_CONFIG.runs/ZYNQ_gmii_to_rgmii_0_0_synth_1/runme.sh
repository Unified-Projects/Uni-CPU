...
HD_PWD='E:/Smart_ZYNQ_SP_SL/Petalinux/08_Petalinux_NET_TEST/NET_TEST/NET_TEST.runs/ZYNQ_gmii_to_rgmii_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZYNQ_gmii_to_rgmii_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZYNQ_gmii_to_rgmii_0_0.tcl
