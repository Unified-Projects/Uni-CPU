...
HD_PWD='Y:/C++/Uni-CPU/CPU_Rev3/CPU_Rev3.runs/CPU_CPU_Module_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_CPU_Module_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_CPU_Module_0_1.tcl
