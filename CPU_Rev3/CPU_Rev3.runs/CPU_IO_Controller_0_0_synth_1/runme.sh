...
HD_PWD='Y:/C++/Uni-CPU/CPU_Rev3/CPU_Rev3.runs/CPU_IO_Controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_IO_Controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_IO_Controller_0_0.tcl
