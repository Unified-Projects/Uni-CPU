...
design_libs=(xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xil_defaultlib gmii_to_rgmii_v4_1_16 util_vector_logic_v2_0_4 lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 blk_mem_gen_v8_4_8)
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work axi_infrastructure_v1_1_0 $vlogan_opts +v2k +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work axi_vip_v1_1_17 $vlogan_opts -sverilog +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work processing_system7_vip_v1_0_19 $vlogan_opts -sverilog +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vhdlan -work gmii_to_rgmii_v4_1_16 $vhdlan_opts \
  ...
  vlogan -work util_vector_logic_v2_0_4 $vlogan_opts +v2k +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work blk_mem_gen_v8_4_8 $vlogan_opts +v2k +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
reset_run()
{
  files_to_remove=(ucli.key CPU_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc CPU_simv.daidir vcs_lib c.obj)
