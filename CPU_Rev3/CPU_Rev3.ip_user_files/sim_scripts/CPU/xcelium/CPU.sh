...
#
# Script generated by Vivado on Wed Oct 16 14:45:07 +0100 2024
...
#
# Usage        : CPU.sh
#                CPU.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                CPU.sh [-reset_run]
#                CPU.sh [-reset_log]
#                CPU.sh [-help]
#
...
#                script (type 'CPU.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname xil_defaultlib -libname gmii_to_rgmii_v4_1_16 -libname util_vector_logic_v2_0_4 -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname blk_mem_gen_v8_4_8 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 xil_defaultlib gmii_to_rgmii_v4_1_16 util_vector_logic_v2_0_4 lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 blk_mem_gen_v8_4_8)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "CPU.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./CPU.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvhdl -work gmii_to_rgmii_v4_1_16 $xmvhdl_opts \
  ...
  xmvlog -work util_vector_logic_v2_0_4 $xmvlog_opts +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/ec67/hdl" +incdir+"../../../../CPU_Rev3.gen/sources_1/bd/CPU/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.CPU xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.CPU -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log CPU_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: CPU.sh [-reset_log]\n\
Usage: CPU.sh [-keep_index]\n\
