...
module CPU_LCD_Controller_0_0(reset, clk, scl, sda, cs, cd, blk, res, fb_we, fb_en, fb_din, 
  fb_addr)
/* synthesis syn_black_box black_box_pad_pin="scl,sda,cs,cd,blk,res,fb_we[7:0],fb_en,fb_din[15:0],fb_addr[15:0]" */
