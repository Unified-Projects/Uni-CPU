...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L cpu -L gmii_to_rgmii_v4_1_14 -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L processing_system7_vip_v1_0_19 -L util_vector_logic_v2_0_4 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ZYNQ cpu.ZYNQ cpu.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ZYNQ -key {Behavioral:sim_1:Functional:ZYNQ} -tclbatch cmd.tcl -protoinst "protoinst_files/ZYNQ.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ZYNQ.wdb xsim.dir libdpi.so)
