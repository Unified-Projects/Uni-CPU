...
HD_PWD='Y:/C++/Uni-CPU/CPURev2/CPURev2.runs/Setup_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Setup_rst_ps7_0_50M_0.tcl
