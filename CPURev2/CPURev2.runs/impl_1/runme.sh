...
HD_PWD='C:/Git/Uni-CPU/CPURev2/CPURev2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Setup_wrapper.tcl -notrace
