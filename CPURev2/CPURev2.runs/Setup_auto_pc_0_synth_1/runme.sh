...
HD_PWD='Y:/C++/Uni-CPU/CPURev2/CPURev2.runs/Setup_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Setup_auto_pc_0.tcl
