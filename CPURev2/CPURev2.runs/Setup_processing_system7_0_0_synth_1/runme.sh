...
HD_PWD='Y:/C++/Uni-CPU/CPURev2/CPURev2.runs/Setup_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Setup_processing_system7_0_0.tcl
