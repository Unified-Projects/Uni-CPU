...
HD_PWD='C:/Git/Uni-CPU/CPURev2/CPURev2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Setup_wrapper.tcl
