...
HD_PWD='Y:/C++/Uni-CPU/CPURev2/CPURev2.runs/Setup_CPU_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_CPU_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Setup_CPU_0_2.tcl
