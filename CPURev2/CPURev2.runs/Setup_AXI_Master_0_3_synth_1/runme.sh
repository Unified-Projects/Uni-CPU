...
HD_PWD='Y:/C++/Uni-CPU/CPURev2/CPURev2.runs/Setup_AXI_Master_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Setup_AXI_Master_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Setup_AXI_Master_0_3.tcl
