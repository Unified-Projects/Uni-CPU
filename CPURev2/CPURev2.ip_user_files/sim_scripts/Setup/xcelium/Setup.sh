...
#
# Script generated by Vivado on Fri Aug 09 23:49:09 +0100 2024
...
#
# Usage        : Setup.sh
#                Setup.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Setup.sh [-reset_run]
#                Setup.sh [-reset_log]
#                Setup.sh [-help]
#
...
#                script (type 'Setup.sh -help' for more information).
#
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname axi_infrastructure_v1_1_0 -libname axi_vip_v1_1_17 -libname processing_system7_vip_v1_0_19 -libname cpu -libname lib_cdc_v1_0_3 -libname proc_sys_reset_v5_0_15 -libname blk_mem_gen_v8_4_8 -libname util_vector_logic_v2_0_4 -libname sim_clk_gen_v1_0_4 -libname generic_baseblocks_v2_1_2 -libname fifo_generator_v13_2_10 -libname axi_data_fifo_v2_1_30 -libname axi_register_slice_v2_1_31 -libname axi_protocol_converter_v2_1_31 -libname axi_clock_converter_v2_1_30 -libname axi_dwidth_converter_v2_1_31 -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm axi_infrastructure_v1_1_0 axi_vip_v1_1_17 processing_system7_vip_v1_0_19 cpu lib_cdc_v1_0_3 proc_sys_reset_v5_0_15 blk_mem_gen_v8_4_8 util_vector_logic_v2_0_4 sim_clk_gen_v1_0_4 generic_baseblocks_v2_1_2 fifo_generator_v13_2_10 axi_data_fifo_v2_1_30 axi_register_slice_v2_1_31 axi_protocol_converter_v2_1_31 axi_clock_converter_v2_1_30 axi_dwidth_converter_v2_1_31)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "Setup.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Setup.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_vip_v1_1_17 $xmvlog_opts -sv +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/4d04/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_19 $xmvlog_opts -sv +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work CPU $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_8 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work util_vector_logic_v2_0_4 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work sim_clk_gen_v1_0_4 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work generic_baseblocks_v2_1_2 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/0c28/hdl/generic_baseblocks_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_data_fifo_v2_1_30 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/9692/hdl/axi_data_fifo_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_register_slice_v2_1_31 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/92b2/hdl/axi_register_slice_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_protocol_converter_v2_1_31 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_clock_converter_v2_1_30 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  "../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/80bf/hdl/axi_clock_converter_v2_1_vl_rfs.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work axi_dwidth_converter_v2_1_31 $xmvlog_opts +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/ec67/hdl" +incdir+"../../../../CPURev2.gen/sources_1/bd/Setup/ipshared/b28c/hdl" +incdir+"C:/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab CPU.Setup CPU.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts CPU.Setup -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log Setup_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Setup.sh -help\" for more information)\n"
    exit 1
  fi
}
...
Usage: Setup.sh [-step]\n\
Usage: Setup.sh [-lib_map_path]\n\
Usage: Setup.sh [-reset_run]\n\
Usage: Setup.sh [-reset_log]\n\
Usage: Setup.sh [-keep_index]\n\
Usage: Setup.sh [-noclean_files]\n\n\
