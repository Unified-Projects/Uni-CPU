...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_17 -L processing_system7_vip_v1_0_19 -L CPU -L lib_cdc_v1_0_3 -L proc_sys_reset_v5_0_15 -L blk_mem_gen_v8_4_8 -L util_vector_logic_v2_0_4 -L generic_baseblocks_v2_1_2 -L fifo_generator_v13_2_10 -L axi_data_fifo_v2_1_30 -L axi_register_slice_v2_1_31 -L axi_protocol_converter_v2_1_31 -L axi_clock_converter_v2_1_30 -L axi_dwidth_converter_v2_1_31 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot Setup CPU.Setup CPU.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Setup -key {Behavioral:sim_1:Functional:Setup} -tclbatch cmd.tcl -protoinst "protoinst_files/Setup.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Setup.wdb xsim.dir libdpi.so)
