# Runtime Tcl commands to interact with - PL_DDR_RW

# Sourcing design address info tcl
set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
source ${bd_path}/PL_DDR_RW_include.tcl
...
# Test: DDR_AXI
set wdata_ddr_axi [get_init_data 0]
create_hw_axi_txn w_ddr_axi_addr [get_hw_axis $jtag_axi_master] -type write -address $axi_gpio_out_addr -data ${wdata_ddr_axi}
create_hw_axi_txn r_ddr_axi_addr [get_hw_axis $jtag_axi_master] -type read -address $axi_gpio_in_addr 
# Initiate transactions
run_hw_axi r_ddr_axi_addr
run_hw_axi w_ddr_axi_addr
run_hw_axi r_ddr_axi_addr
set rdata_tmp [get_property DATA [get_hw_axi_txn r_ddr_axi_addr]]
set DE [ get_done_and_error_bit $rdata_tmp 1 0 ]
# Compare read data
if { $DE == 01 } {
	puts "Data comparison test pass for - DDR_AXI"
} else {
	puts "Data comparison test fail for - DDR_AXI, rdata-$rdata_tmp expected-01 actual-$DE"
	inc ec
}
